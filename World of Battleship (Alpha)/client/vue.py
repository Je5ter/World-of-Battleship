...
class Vue(FloatLayout):
    ...
    def __init__(self, controleur, **kwargs):
        ...
        self.panelIntro = BoxLayout(orientation='vertical', size_hint=(1, 0.07),
                                    pos_hint={'center_x': 0.5, 'center_y': 0.07})
        self.panelAccueil = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 0.3),
                                      pos_hint={'center_x': 0, 'center_y': 0.20})
        self.panelMenuJvsIA = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 0.7),
                                        pos_hint={'center_x': 0, 'center_y': 0.5})
        self.panelMenuIAvsIA = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 0.8),
                                         pos_hint={'center_x': 0, 'center_y': 0.5})
        self.panelGameJvsIA = BoxLayout(padding=0)
        self.panelGameIAvsIA = BoxLayout(padding=0)
        self.panelOption = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 0.5),
                                     pos_hint={'center_x': 0, 'center_y': 0.5})
        self.panelStatsIA = BoxLayout(orientation='vertical', spacing=10, size_hint=(1, 0.06),
                                      pos_hint={'center_x': 0, 'center_y': 0.035})
        
        self.buttonJoueurvsJoueur = Button(text='Player VS Player', border=(0, 0, 0, 0),
                                           background_normal='client/ressources/Unselected.png',
                                           background_down='client/ressources/Selected.png', font_size=25,
                                           size_hint=(0.2, 1), pos_hint={'center_x': 0.282})
        self.buttonJoueurvsIA = Button(text='Player VS A.I.', border=(0, 0, 0, 0),
                                       background_normal='client/ressources/Unselected.png',
                                       background_down='client/ressources/Selected.png', font_size=25,
                                       size_hint=(0.2, 1), pos_hint={'center_x': 0.282})
        self.buttonIAvsIA = Button(text='A.I. VS A.I.', border=(0, 0, 0, 0),
                                   background_normal='client/ressources/Unselected.png',
                                   background_down='client/ressources/Selected.png', font_size=25, size_hint=(0.2, 1),
                                   pos_hint={'center_x': 0.282})
        self.buttonSkip = Button(text='Skip', border=(0, 0, 0, 0), background_normal='client/ressources/Unselected.png',
                                 background_down='client/ressources/Selected.png', font_size=15, size_hint=(0.1, 1),
                                 pos_hint={'center_x': 0.95})
        self.buttonRetourAccueil = Button(text='Home Page', border=(0, 0, 0, 0),
                                          background_normal='client/ressources/Unselected.png',
                                          background_down='client/ressources/Selected.png', font_size=20,
                                          size_hint=(0.2, 1), pos_hint={'center_x': 0.75})
        self.buttonRetourAccueil1 = Button(text='Home Page', border=(0, 0, 0, 0),
                                           background_normal='client/ressources/Unselected.png',
                                           background_down='client/ressources/Selected.png', font_size=20,
                                           size_hint=(0.2, 1), pos_hint={'center_x': 0.75})
        self.buttonRetourAccueil2 = Button(text='Home Page', border=(0, 0, 0, 0),
                                           background_normal='client/ressources/Unselected.png',
                                           background_down='client/ressources/Selected.png', font_size=20,
                                           size_hint=(0.2, 1), pos_hint={'center_x': 0.5})
        self.buttonStartJvsIA = Button(text='Start', border=(0, 0, 0, 0),
                                       background_normal='client/ressources/Unselected.png',
                                       background_down='client/ressources/Selected.png', font_size=20,
                                       size_hint=(0.2, 1), pos_hint={'center_x': 0.75})
        self.buttonStartIAvsIA = Button(text='Start', border=(0, 0, 0, 0),
                                        background_normal='client/ressources/Unselected.png',
                                        background_down='client/ressources/Selected.png', font_size=20,
                                        size_hint=(0.2, 1), pos_hint={'center_x': 0.75})
        self.buttonOption = Button(text='Option', border=(0, 0, 0, 0),
                                   background_normal='client/ressources/Unselected.png',
                                   background_down='client/ressources/Selected.png', font_size=20, size_hint=(0.2, 1),
                                   pos_hint={'center_x': 0.75})
        self.buttonPlus = Button(text='+', border=(0, 0, 0, 0), background_normal='client/ressources/Unselected.png',
                                 background_down='client/ressources/Selected.png', font_size=30, size_hint=(0.2, 1),
                                 pos_hint={'center_x': 0.75})
        self.buttonMoins = Button(text='-', border=(0, 0, 0, 0), background_normal='client/ressources/Unselected.png',
                                  background_down='client/ressources/Selected.png', font_size=30, size_hint=(0.2, 1),
                                  pos_hint={'center_x': 0.75})
        self.buttonRetour = Button(text='Done', border=(0, 0, 0, 0),
                                   background_normal='client/ressources/Unselected.png',
                                   background_down='client/ressources/Selected.png', font_size=20, size_hint=(0.2, 1),
                                   pos_hint={'center_x': 0.75})
        
        self.dropdown = DropDown()
        self.buttonIARandom = Button(text='IARandom', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                     background_normal='client/ressources/DropDownList.png')
        self.buttonIAProba = Button(text='IAProba', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                    background_normal='client/ressources/DropDownList.png')
        self.buttonIADecroi = Button(text='IADecroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                     background_normal='client/ressources/DropDownList.png')
        self.buttonIACroi = Button(text='IACroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        self.buttonIADia = Button(text='IADia', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                  background_normal='client/ressources/DropDownList.png')
        self.buttonIAQua = Button(text='IAQua', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                  background_normal='client/ressources/DropDownList.png')
        self.buttonIACinq = Button(text='IACinq', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        ...
        self.mainDropDown = Button(text='A.I. Selection', border=(0, 0, 0, 0),
                                   background_normal='client/ressources/Unselected.png',
                                   background_down='client/ressources/Selected.png', font_size=20, size_hint=(0.2, 1),
                                   pos_hint={'center_x': 0.75})
        
        self.dropdown1 = DropDown()
        self.buttonIARandom1 = Button(text='IARandom', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                      background_normal='client/ressources/DropDownList.png')
        self.buttonIAProba1 = Button(text='IAProba', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                     background_normal='client/ressources/DropDownList.png')
        self.buttonIADecroi1 = Button(text='IADecroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                      background_normal='client/ressources/DropDownList.png')
        self.buttonIACroi1 = Button(text='IACroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                    background_normal='client/ressources/DropDownList.png')
        self.buttonIADia1 = Button(text='IADia', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        self.buttonIAQua1 = Button(text='IAQua', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        self.buttonIACinq1 = Button(text='IACinq', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                    background_normal='client/ressources/DropDownList.png')
        ...
        self.mainDropDown1 = Button(text='A.I. Selection', border=(0, 0, 0, 0),
                                    background_normal='client/ressources/Unselected.png',
                                    background_down='client/ressources/Selected.png', font_size=20, size_hint=(0.2, 1),
                                    pos_hint={'center_x': 0.75})
        
        self.dropdown2 = DropDown()
        self.buttonIARandom2 = Button(text='IARandom', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                      background_normal='client/ressources/DropDownList.png')
        self.buttonIAProba2 = Button(text='IAProba', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                     background_normal='client/ressources/DropDownList.png')
        self.buttonIADecroi2 = Button(text='IADecroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                      background_normal='client/ressources/DropDownList.png')
        self.buttonIACroi2 = Button(text='IACroi', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                    background_normal='client/ressources/DropDownList.png')
        self.buttonIADia2 = Button(text='IADia', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        self.buttonIAQua2 = Button(text='IAQua', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                   background_normal='client/ressources/DropDownList.png')
        self.buttonIACinq2 = Button(text='IACinq', size_hint_y=None, height=44, border=(0, 0, 0, 0),
                                    background_normal='client/ressources/DropDownList.png')
        ...
        self.mainDropDown2 = Button(text='A.I. Selection', border=(0, 0, 0, 0),
                                    background_normal='client/ressources/Unselected.png',
                                    background_down='client/ressources/Selected.png', font_size=20, size_hint=(0.2, 1),
                                    pos_hint={'center_x': 0.75})
        ...
        self.textPartie = TextInput(hint_text='1', input_filter='int', font_size=20, size_hint=(0.2, 1),
                                    pos_hint={'center_x': 0.75})
    ...
    def affichePanelAccueil(self):
        ...
        with self.panelPrincipale.canvas.before:
            self.video2 = Video(source='client/ressources/Accueil.mp4', state='play', size=(1280, 736), eos='loop',
                                volume=0)
        with self.panelPrincipale.canvas.after:
            ...
            self.img = Image(source='client/ressources/World_of_Battleship_nologo.png', size=(571.5, 215),
                             pos=(80, 450))
    ...
    def affichePanelJoueurVsIA(self):
        ...
        self.T = []
        for i in range(100):
            self.B.append(Button(text='B ' + str(int(i / 10)) + ' ' + str(i % 10),
                                 background_normal='client/ressources/Unselected.png'))
            self.T.append(Button(text='T ' + str(int(i / 10)) + ' ' + str(i % 10),
                                 background_normal='client/ressources/Unselected.png'))
    ...
    def affichePanelStatsIA(self, J1, J2, minmaxJ1, minmaxJ2):
        ...
        with self.panelPrincipale.canvas.after:
            ...
            pourcentJ1 = Label(text='Percentage of victory = ' + str(round(J1[1] * 100, 3)) + '%', font_size=25,
                               bold=True, pos=(350, 500))
            coupMinJ1 = Label(text='Minimum number of shots = ' + str(minmaxJ1[1]), font_size=25, bold=True,
                              pos=(350, 400))
            coupMaxJ1 = Label(text='Maximum number of shots = ' + str(minmaxJ1[0]), font_size=25, bold=True,
                              pos=(350, 300))
            coupMoyJ1 = Label(text='Average number of shots = ' + str(round(J1[2], 3)), font_size=25, bold=True,
                              pos=(350, 200))
            
            nomJ2 = Label(text=str(J2[0]), font_size=30, bold=True, pos=(850, 600))
            pourcentJ2 = Label(text='Percentage of victory = ' + str(round(J2[1] * 100, 3)) + '%', font_size=25,
                               bold=True, pos=(850, 500))
            coupMinJ2 = Label(text='Minimum number of shots = ' + str(minmaxJ2[1]), font_size=25, bold=True,
                              pos=(850, 400))
            coupMaxJ2 = Label(text='Maximum number of shots = ' + str(minmaxJ2[0]), font_size=25, bold=True,
                              pos=(850, 300))
            coupMoyJ2 = Label(text='Average number of shots = ' + str(round(J2[2], 3)), font_size=25, bold=True,
                              pos=(850, 200))
            
            nbParties = Label(text='Number of games : ' + str(self.textPartie.text), font_size=25, bold=True,
                              pos=(600, 100))
    ...
    def inscriptionBateaux(self):
        with self.panelPrincipale.canvas.after:
            self.boat = Image(
                source='client/ressources/Bateaux/Bateau' + str(self.indice + 1) + '_' + str(self.ori) + '.png')
