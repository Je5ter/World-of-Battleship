...
class PartiePredef:
    ...
    def Stats(self,tab):
        ...
        print('Avec un max de : '+str(self.minmax(self.J1[0])[0])+' et un min de : '+str(self.minmax(self.J1[0])[1]))
        print('le joueur : '+self.J2[0]+' a gagné '+str(self.J2[1]*100)+'% du temps')
        print('Son nombre de coups gagnants moyen est : '+str(self.J2[2]))
        print('Avec un max de : '+str(self.minmax(self.J2[0])[0])+' et un min de : '+str(self.minmax(self.J2[0])[1]))
