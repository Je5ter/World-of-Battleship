...
class Controleur:
    ...
    def actionButtonStartIAvsIA(self, instance):#Button Start menu IAvsIA
        ...
        if self.vue.textPartie.text == '' or self.vue.textPartie.text == '1':
            ...
            minmaxJ1 = [self.partiePredef.minmax(self.partiePredef.J1[0])[0], self.partiePredef.minmax(self.partiePredef.J1[0])[1]]
            minmaxJ2 = [self.partiePredef.minmax(self.partiePredef.J2[0])[0], self.partiePredef.minmax(self.partiePredef.J2[0])[1]]
    ...
    def triggerTourIA(self, dt):
        ...
        if self.partie.current == 0:
            self.vue.affichageTirsIA1(self.partie.joueurs[0].tabTirs, self.partie.joueurs[0].tirX, self.partie.joueurs[0].tirY)
        else:
            self.vue.affichageTirsIA2(self.partie.joueurs[1].tabTirs, self.partie.joueurs[1].tirX, self.partie.joueurs[1].tirY)
    ...
    def choixPlacement(self, instance):
        ...
        self.partie.joueurs[0].Bateaux.pos[self.vue.indice] = self.partie.joueurs[0].Bateaux.placement(int(split[1])-ajustementX, int(split[2])-ajustementY, sens, self.vue.taille[self.vue.indice])
